...
from sqlgen.exceptions import DuplicatedStudyError
from sqlgen.storages import base
from sqlgen.storages.base import DEFAULT_STUDY_NAME_PREFIX
from sqlgen.study import StudyDirection
from sqlgen.study import StudySummary
...
class InMemoryStorage(base.BaseStorage):
    ...
    def change_trial_id(self, trial_id, int):
        # type: (int, float) -> None
